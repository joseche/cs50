...
class NimAI:
    ...
    def get_q_value(self, state, action):
        ...
        return self.q[t] if t in self.q.keys() else 0
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        """
        t = (tuple(state), action)
        self.q[t] = old_q + self.alpha * ((reward + future_rewards) - self.get_q_value(state, action))
    ...
    def best_future_reward(self, state):
        ...
        `state`, return 0.
        """
        available_options = Nim.available_actions(state)
        if available_options == set():
            return 0
        max_reward = -math.inf
    ...
    def choose_action(self, state, epsilon=True):
        ...
        q_values = {action: self.get_q_value(state, action) for action in available}
